...
import com.example.appthitracnghiem.adapter.QuizAdapter
...
class FragmentHome : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var linearLayoutManager : LinearLayoutManager = LinearLayoutManager(requireActivity(),LinearLayoutManager.VERTICAL,false)
    ...
    private fun getData() {
        viewModelGeneral.listQuizLive.observe(requireActivity(), Observer { listQuiz ->
            if(listQuiz != null && recycleListLiveQuizzes != null) {
                var adapterQuiz: QuizAdapter = QuizAdapter(listQuiz, requireActivity())
